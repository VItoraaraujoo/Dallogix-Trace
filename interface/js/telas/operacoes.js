...
<label class="date-filter-field">Data inicial<div class="date-filter-control"><input name="date_from" type="date" value="${esc(filters.date_from || "")}" /><button class="date-clear" data-action="clear-manifest-date" data-field="date_from" type="button" aria-label="Limpar data inicial">Limpar</button></div></label>
<label class="date-filter-field">Data final<div class="date-filter-control"><input name="date_to" type="date" value="${esc(filters.date_to || "")}" /><button class="date-clear" data-action="clear-manifest-date" data-field="date_to" type="button" aria-label="Limpar data final">Limpar</button></div></label>
